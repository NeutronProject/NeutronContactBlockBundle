...
use Neutron\Widget\ContactBlockBundle\Model\ContactBlockInterface;

use Neutron\Widget\ContactBlockBundle\Model\ContactBlockReferenceInterface;
...
class AbstractContactInfoReference implements ContactBlockReferenceInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Neutron\Widget\ContactBlockBundle\Model\WidgetContactBlockInterface", inversedBy="references")
     * @ORM\JoinColumn(onDelete="CASCADE")
     */
    protected $widget;
    
    /**
     * @ORM\ManyToOne(targetEntity="Neutron\Widget\ContactBlockBundle\Model\ContactBlockInterface",  fetch="EAGER")
     * @ORM\JoinColumn(onDelete="CASCADE")
     */
    protected $inversed;
