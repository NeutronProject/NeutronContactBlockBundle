...
class ContactBlockManagementDataGrid
{
    ...
    public function build ()
    {
        ...
        $dataGrid
            ...
            ->setAddBtnUri($this->router->generate('neutron_contact_block.backend.contact_block.update', array(), true))
            ->enableEditButton(true)
            ->setEditBtnUri($this->router->generate('neutron_contact_block.backend.contact_block.update', array('id' => '{id}'), true))
            ->enableDeleteButton(true)
            ->setDeleteBtnUri($this->router->generate('neutron_contact_block.backend.contact_block.delete', array('id' => '{id}'), true))
        ;
